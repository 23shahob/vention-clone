    ...
    <div className="flex">
      ...
      <div>
        <div className="border-b border-b-gray-300 px-[26px] pt-[145px] font-medium">
          ...
          <p className="text-end text-[17px] font-normal">
        ...
        <div className="flex border-b border-b-gray-300">
          <div className="w-[50%]">
            <div className="h-[190px] px-[26px] py-[38px]">
              <p className="text-[20px] font-medium text-[#52002D]">
                Key stats
              </p>
            </div>
            <div className="flex h-[190px]">
              <div className="w-[50%] px-[26px] py-[38px] leading-none">
                <h1 className="mb-[26px] text-start text-[75px] text-[#52002D]">
                  36
                </h1>
                <p className="text-[17px]">month average engagement</p>
              </div>
              <div className="w-[50%] px-[26px] py-[38px] leading-none">
                <h1 className="mb-[26px] text-start text-[75px] text-[#52002D]">
                  20+
                </h1>
                <p className="text-[17px]">client IPOs supported</p>
              </div>
            </div>
          </div>
          <div className="w-[50%]">
            <div className="flex h-[190px]">
              <div className="w-[50%] px-[26px] py-[38px] leading-none">
                ...
                <p className="text-[17px]">award-winning clients</p>
              </div>
              <div className="w-[50%] px-[26px] py-[38px] leading-none">
                <h1 className="mb-[26px] text-start text-[75px] text-[#52002D]">
                  $15B+
                </h1>
                <p className="text-[17px]">in client acquisitions</p>
              </div>
            </div>
            <div className="flex h-[190px]">
              <div className="w-[50%] px-[26px] py-[38px] leading-none">
              ...
              <div className="w-[50%] px-[26px] py-[38px] leading-none">
                ...
                <p className="text-[17px]">world-class engineers</p>
              </div>
            </div>
          </div>
        </div>
        <div className="border-b border-b-gray-300 px-[26px] pb-[38px] pt-[147px]">
          <h3 className="mb-5 text-[38px] font-medium leading-none">
            Trusted by the best
          </h3>
        ...
        <div className="flex border-b border-b-gray-300">
          ...
          <div className="w-[50%] px-[26px] pb-[38px] pt-[147px]">
            <p className="mb-5 text-[20px] text-[#52002D]">
              We speak your language
            </p>
            <p className="mb-5 text-[38px] font-medium leading-[130%]">
